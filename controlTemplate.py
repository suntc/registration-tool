...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.registrationBtn, 4, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.hmBtn, 5, 0, 1, 2)
        ## tree widget
        self.hmTree = QtGui.QTreeWidget(Form)
        self.hmTree.setColumnCount(1)
        self.hmTree.setHeaderLabel("Channels (double click)")
        ...
        self.gridLayout.addWidget(self.hmTree, 6, 0, 1, 3)
        '''
        ...
        self.gridLayout.addWidget(self.dummy, 7, 0)
